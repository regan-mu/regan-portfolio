...
const NavBar = () => {
    ...
    return (
        <nav className="flex w-full flex-col-reverse gap-5 md:flex-row md:justify-between md:items-center">
            ...
            <div className="py-3 h-full flex items-center w-full bg-gray-500 rounded-md px-5 md:px-10">
                <ul className="list-none flex gap-4 w-full text-sm md:gap-10 md:text-base">
