...
const TestimonialCard: React.FC<ITestimonial> = ({id, client, message, website, role, company}) => {
    return (
        <article className="w-full h-auto flex flex-col gap-10 justify-center items-center rounded-xl relative p-5 md:px-20">
            <div className="relative w-full before:absolute before:content-['\201c'] before:dark:text-text before:text-gray-400 before:-z-10 before:text-9xl before:-top-7 before:-left-5 before:font-extrabold"></div>
            <blockquote className="relative font-poppins text-xs text-center dark:text-gray-300 text-darkBg font-extralight md:text-sm">
                {message}
            </blockquote>
