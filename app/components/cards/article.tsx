...
const ArticleCard = ({image, title, intro, date, link}: IArticle) => {
    return (
        <Link className="flex shadow-md shadow-gray-700 flex-col min-w-full rounded-md h-80 overflow-hidden hover:scale-[1.03] duration-100 delay-75 group sm:w-80 md:min-w-96" rel="noopener noreferrer" target="_blank" href={link}  >
