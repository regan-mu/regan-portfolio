...
const PortfolioProject: React.FC<IProject> = ({id, title, description, demo, github, tools}) => {
    return (
        <article className="min-w-full relative h-80 flex flex-col overflow-hidden gap-5 rounded-xl bg-[#444444] shadow-lg shadow-gray-800 sm:w-80 md:min-w-96">
            ...
            <div className="flex absolute left-0 w-full bottom-0 justify-center gap-2 flex-wrap text-xs text-white bg-darkBg py-4 px-5">
